            ...
            <div class="nav-list">
                <ul>
                    ...
                    <li class="nav-tab nav-ul a_active nav-show">
                        ...
                        <div class="nav-box">
                            <a href="/dept/findDept" class="li-a-a active">部门列表</a>
        ...
        <div class="content-page" ref="cPage">
            ...
            <div class="search">
                <form action="${pageContext.request.contextPath}/dept/findDept">
                    ...
                    <a href="/dept/toadd" class="button button-glow button-border button-rounded button-primary">添加部门</a>
                </form>
            </div>
            <!--账单表格 样式和供应商公用-->
            <table class="providerTable" cellpadding="0" cellspacing="0">
                ...
                <c:forEach items="${depts}" var="dept">
                    <tr>
                        ...
                        <td class="caozuo">
                            <a href="/dept/view?deptId=${dept.deptId}" style="width: 60px;" class="button button-3d button-primary button-rounded">查看</a>
                            <a href="/dept/toupdate?deptId=${dept.deptId}" style="width: 60px;" class="button button-3d button-primary button-rounded">修改</a>
                            <input type="button" onclick="del(${dept.deptId})" class="button button-3d button-caution button-rounded" style="width: 60px;" value="删除">
                        </td>
                    </tr>
                </c:forEach>
...
<div class="remove" id="removeBi"></div>
