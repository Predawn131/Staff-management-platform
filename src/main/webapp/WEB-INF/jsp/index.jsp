    ...
    <script>
        WIDGET = {
            "CONFIG": {
                ...
                "dataColor": "FFFFFF",
                "borderRadius": "10",
                "key": "588e7ad92a274ba49a753999f6adb6fe"
            }
        }
    </script>
...
<%--    </div>--%>
<%--    <div class="right">--%>
<%--&lt;%&ndash;        <iframe scrolling="no" src="https://tianqiapi.com/api.php?style=tr&skin=cake" frameborder="0" width="325" height="220" allowtransparency="true"></iframe>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <iframe width="660" scrolling="no" height="460" frameborder="0" allowtransparency="true" src="https://i.tianqi.com?c=code&id=57&bdc=%2300B0F0&icon=1&site=12"></iframe>&ndash;%&gt;--%>
<%--        <div id="he-plugin-standard"></div>--%>
