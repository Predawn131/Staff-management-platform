                    ...
                    <ul>
                        ...
                        <li class="nav-tab nav-ul  a_active nav-show">
                            ...
                            <div class="nav-box">
                                ...
                                <a href="/user/toadd" class="li-a-a active">添加管理员</a>
                            </div>
                        </li>
                        <li class="nav-tab nav-ul">
                            <a href="#" class="li-a"><i class='iconfont icon-tongxunlu'></i> 职工管理
        ...
        <div class="content-page" ref="cPage">
            ...
            <div class="providerAdd">
                <form action="/user/add">
                    ...
                    <div>
                        <label for="userRelname">用户真实名称：</label>
                        <input type="text" name="userRelname" id="userRelname" required />
                        <span>*请输入用户真实名称</span>
                    </div>
                    <div>
                    ...
                    <div>
                        <label>身份：</label>
                        管理员：<input type="radio" name="power" value="1" required />
                        普通用户：<input type="radio" name="power" value="0" required />
                        <span>*请选择身份</span>
                    </div>
