        ...
        <div class="content-page" ref="cPage">
            ...
            <div class="search">
                <form action="${pageContext.request.contextPath}/emp/findEmp">
                    <span>员工名：</span>
                    <input type="text" placeholder="请输入员工名" name="empName" value=""/>
                    <span>所在部门：</span>
                    <input type="text" placeholder="请输入员工所在部门" name="empDept" value=""/>

                    <input type="submit" value="查询" class="button button-glow button-border button-rounded button-primary"/>
                    <a href="/emp/toadd" class="button button-glow button-border button-rounded button-primary">添加员工</a>
                </form>
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                ...
                <c:forEach items="${emps}" var="emp">
                    <tr>
                        ...
                        <td class="caozuo">
                            <a href="/emp/view?empId=${emp.empId}" style="width: 60px;" class="button button-3d button-primary button-rounded">查看</a>
                            <a href="/emp/toupdate?empId=${emp.empId}" style="width: 60px;" class="button button-3d button-primary button-rounded">修改</a>
                            <input type="button" onclick="del(${emp.empId})" class="button button-3d button-caution button-rounded" style="width: 60px;" value="删除">
                        </td>
                    </tr>
                </c:forEach>
                ...
                <tr valign="top">
                    <td align="center" class="font3">
                        <yyf:pager
                                ...
                                submitUrl="${pageContext.request.contextPath}/emp/findEmp?pageIndex={0}&empName=${emp.empName}&empDept=${emp.empDept}"/>
