        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach items="${emps}" var="emp">
                <tr>
                    ...
                    <td>${emp.empPhone}</td>
                    <td>
                        <a href="/emp/view?empId=${emp.empId}"><img src="/img/look.png" alt="查看" title="查看"/></a>
                        <a href="/emp/toupdate?empId=${emp.empId}"><img src="/img/xg.png" alt="修改" title="修改"/></a>
                        <a href="/emp/del?empId=${emp.empId}" class="removeBill"><img src="/img/sc.png" alt="删除" title="删除"/></a>
                    </td>
                </tr>
            </c:forEach>
