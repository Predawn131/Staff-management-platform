        ...
        <div class="content-page" ref="cPage">
            ...
            <div class="search">
                <form action="${pageContext.request.contextPath}/travel/findTvl">
                    ...
                    <a href="/travel/toadd" class="button button-glow button-border button-rounded button-primary">申请出差</a>
                </form>
            </div>
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                ...
                <c:forEach items="${tvls}" var="tvl">
                    <tr>
                        ...
                        <td class="caozuo">
                            <a href="/travel/view?tvlId=${tvl.tvlId}"style="width: 60px;" class="button button-3d button-primary button-rounded">查看</a>
                            <a href="/travel/toupdate?tvlId=${tvl.tvlId}"style="width: 60px;" class="button button-3d button-primary button-rounded">修改</a>
                            <input type="button" onclick="del(${tvl.tvlId})" class="button button-3d button-caution button-rounded" style="width: 60px;" value="删除">
                        </td>
                    </tr>
                </c:forEach>
            </table>
