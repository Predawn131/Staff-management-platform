    ...
    <div class="nav-right" ref="navRight">
        ...
        <div class="content-page" ref="cPage">
            <div class="location">
                ...
                <span>部门管理页面 >> 部门修改页面</span>
            </div>
            <div class="providerAdd">
                <form action="/dept/update">
                    <div>
                        <label for="deptName">部门名称：</label>
                        <input type="text" name="deptName" id="deptName" value="${dept.deptName}" readonly required/>
                        <span >*请输入部门名称</span>
                    </div>
                    <div>
                        <label for="deptPhone">部门电话：</label>
                        <input type="text" name="deptPhone" id="deptPhone" value="${dept.deptPhone}" required/>
                        <span >*请输入部门电话</span>
                    </div>
                    <div>
                        <label for="deptManager">部门经理：</label>
                        <input type="text" name="deptManager" id="deptManager"value="${dept.deptManager}" required/>
                        <span>*请输入部门经理姓名</span>
                    </div>
